...
def vehicle_stop(apiList, vehicleoControl1):
    """
    ...
    start_x = vehicleoControl1.start_position_x
    start_y = vehicleoControl1.start_position_y
    ...
    vehicleoControl1.__throttleSet__(throttle=1, speed=10, keyboardModel=False)

    pre_brake = 3
    # 判断是否到达刹车开始位置
    if distance_to_target + pre_brake >= 50:
        vehicleoControl1.__brakeSet__(brake=1, speed=0, keyboardModel=False)
        print('开始刹车')
    # 编码控制指令
            ...
            while True:
                ...
                if dataState:
                    ...
                    if loop_counter == 0:
                        ...
                        control_dict_demo = vehicle_stop(apiList, vehicleoControl1)
